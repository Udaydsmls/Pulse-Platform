...
// KafkaConsumer wraps a sarama consumer group to consume all domain event topics.
...
// NewConsumer creates a new KafkaConsumer subscribed to all domain event topics.
