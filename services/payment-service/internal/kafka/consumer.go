...
// KafkaConsumer wraps a sarama consumer group to consume inventory events.
...
// NewConsumer creates a new KafkaConsumer that consumes the "inventory.events" topic.
